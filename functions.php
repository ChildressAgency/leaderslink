...
//allow editors to view Flamingo messages
remove_filter( 'map_meta_cap', 'flamingo_map_meta_cap' );

add_filter( 'map_meta_cap', 'leaderslink_flamingo_map_meta_cap', 9, 4 );

function leaderslink_flamingo_map_meta_cap( $caps, $cap, $user_id, $args ) {
    $meta_caps = array(
