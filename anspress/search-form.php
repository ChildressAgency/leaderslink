...
<form id="ap-search-form" class="ap-search-form" action="<?php echo esc_url( ap_get_link_to( '/' ) ); ?>">
	...
	<div class="ap-search-inner no-overflow">
	    <input name="ap_s" type="text" class="ap-search-input ap-form-input" placeholder="<?php esc_attr_e( 'Search discussions...', 'anspress-question-answer' ); ?>" value="<?php echo sanitize_text_field( get_query_var( 'ap_s' ) ); ?>" />
    </div>
</form>
